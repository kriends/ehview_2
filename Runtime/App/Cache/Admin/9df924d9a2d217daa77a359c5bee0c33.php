...
<link rel="shortcut icon" href="/ehviews/Public/static/images/favicon.jpg">
        <link rel="stylesheet" type="text/css" href="/ehviews/Public/admin/css/app.css">
        <link id="layout-theme" rel="stylesheet" type="text/css" href="/ehviews/Public/admin/css/default.min.css">
        <!-- JS -->
      <script type="text/javascript" src="/ehviews/Public/static/jquery-1.10.2.min.js"></script>
...
<div class="example-code">
        ...
        <ul class="notifications-box">
            <li>
                ...
                <span class="notification-text">zswin社交类博客系统QQ群：365645950</span>
            ...
            <li>
                ...
                <span class="notification-text">官网地址：www.zswin.cn</span>
                <div class="notification-time">
            ...
            <li>
                ...
                <span class="notification-text">开发所需：zswin手册，bootstrap3.3.0官网手册，ThinkPHP3.2.3手册</span>
                <div class="notification-time">
             ...
             <li>
                ...
                <span class="notification-text">zswin属于新疆喀什飞天索美文化传媒有限公司，如有商务合作请联系QQ：49007623</span>
                <div class="notification-time">
        ...
        <![endif]-->
        <script type="text/javascript" src="/ehviews/Public/static/uploadify/jquery.uploadify.min.js"></script>
        <link rel="stylesheet" type="text/css" href="/ehviews/Public/static/uploadify/uploadify.css"> 
        <script type="text/javascript" src="/ehviews/Public/static/layer/layeradmin.js"></script>
         <script type="text/javascript" src="/ehviews/Public/static/kindeditor/kindeditor-all.js"></script>
         <script type="text/javascript" src="/ehviews/Public/admin/js/app.js"></script>
         <script type="text/javascript" src="/ehviews/Public/admin/js/core.js"></script>
